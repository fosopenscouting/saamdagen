...
/***
 * Source gekopieerd van [DividerItemDecoration]. Enkel [getItemOffsets] is gewijzigd zodat de divider boven het item wordt getekend ipv er onder.
 */
class ScheduleDividerItemDecoration(context: Context, orientation: Int, sessions: List<Session>): RecyclerView.ItemDecoration()
    {
        ...
        private val letters: Map<Int, Char> = indexSessionHeaders(sessions).map {
